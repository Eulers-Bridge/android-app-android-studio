...
public class CandidatePositionFragment extends Fragment {
	...
	public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Position position = Parcels.unwrap(getArguments().getParcelable(Constants.FRAGMENT_EXTRA_CANDIDATE_POSITION));
	...
	private void addTableRow(Candidate candidate) {
        ...
        candidateProfileImage.setOnClickListener(view -> {
            ...
            args.putLong(Constants.FRAGMENT_EXTRA_PROFILE_ID, candidate.userId);

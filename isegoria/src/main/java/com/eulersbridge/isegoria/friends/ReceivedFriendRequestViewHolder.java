...
class ReceivedFriendRequestViewHolder extends RecyclerView.ViewHolder {

    private FriendRequest item;
    private @NonNull
    final ViewHolderDataSource dataSource;

    final private ImageView imageView;
    final private TextView nameTextView;
    final private TextView institutionTextView;

    ReceivedFriendRequestViewHolder(View itemView, @NonNull ViewHolderDataSource dataSource) {
        super(itemView);
        ...
        actionImageView.setImageResource(R.drawable.addedinactive);
        actionImageView.setOnClickListener(view ->  dataSource.onActionClick(item));
    }

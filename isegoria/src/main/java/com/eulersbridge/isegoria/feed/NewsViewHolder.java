...
class NewsViewHolder extends LoadingAdapter.ItemViewHolder<NewsArticle> {
    ...
    NewsViewHolder(View itemView) {
        ...
        imageView.setOnClickListener(view -> {
            ...
            extras.putParcelable(Constant.ACTIVITY_EXTRA_NEWS_ARTICLE, Parcels.wrap(item));
    ...
    protected void setItem(@Nullable NewsArticle item) {
        ...
        if (item == null) {
            ...
            String dateTime = Utils.convertTimestampToString(dateTextView.getContext(), item.dateTimestamp);

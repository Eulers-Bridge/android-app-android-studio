...
class EventViewHolder extends LoadingAdapter.ItemViewHolder<Event> implements View.OnClickListener {
    ...
    protected void setItem(@Nullable Event item) {
        ...
        if (item == null) {
            ...
            String dateTime = Utils.convertTimestampToString(detailsTextView.getContext(), item.date);
    ...
    public void onClick(View view) {
        ...
        extras.putParcelable(Constant.ACTIVITY_EXTRA_EVENT, Parcels.wrap(item));

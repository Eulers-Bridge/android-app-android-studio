...
public interface API {
    ...
    Call<List<Like>> getNewsArticleLikes(@Path("articleId") long articleId);

    @PUT("newsArticle/{articleId}/likedBy/{userEmail}/")
    Call<LikeResponse> likeArticle(@Path("articleId") long photoId, @Path("userEmail") String userEmail);
    ...
    Call<List<Like>> getPhotoLikes(@Path("photoId") long photoId);

    @PUT("photo/{photoId}/likedBy/{userEmail}/")
    Call<LikeResponse> likePhoto(@Path("photoId") long photoId, @Path("userEmail") String userEmail);
